System.register(['core-js', 'aurelia-task-queue', 'aurelia-dependency-injection', 'aurelia-metadata'], function (_export) {
  'use strict';

  var core, TaskQueue, Container, Decorators, Metadata, tempContextsRest, tempCallablesRest, objectChangedContext, keyChangedContext, memberChangedContext, AccessKeyedObserver, EDIT_LEAVE, EDIT_UPDATE, EDIT_ADD, EDIT_DELETE, arraySplice, hasObjectObserve, hasArrayObserve, ModifyCollectionObserver, CollectionLengthObserver, arrayProto, ModifyArrayObserver, ArrayObserveObserver, conditionAlways, childChangedContext, CompositeObserver, Expression, Chain, ValueConverter, Assign, Conditional, AccessScope, AccessMember, AccessKeyed, CallScope, CallMember, CallFunction, Binary, PrefixNot, LiteralPrimitive, LiteralString, LiteralArray, LiteralObject, Unparser, evalListCache, bindingMode, Token, Lexer, Scanner, OPERATORS, $EOF, $TAB, $LF, $VTAB, $FF, $CR, $SPACE, $BANG, $DQ, $$, $PERCENT, $AMPERSAND, $SQ, $LPAREN, $RPAREN, $STAR, $PLUS, $COMMA, $MINUS, $PERIOD, $SLASH, $COLON, $SEMICOLON, $LT, $EQ, $GT, $QUESTION, $0, $9, $A, $E, $Z, $LBRACKET, $BACKSLASH, $RBRACKET, $CARET, $_, $a, $e, $f, $n, $r, $t, $u, $v, $z, $LBRACE, $BAR, $RBRACE, $NBSP, EOF, Parser, ParserImplementation, mapProto, ModifyMapObserver, DelegateHandlerEntry, DefaultEventStrategy, EventManager, DirtyChecker, DirtyCheckProperty, SetterObserver, OoPropertyObserver, version, OoObjectObserver, XLinkAttributeObserver, DataAttributeObserver, StyleObserver, ValueAttributeObserver, selectArrayContext, SelectValueObserver, checkedArrayContext, CheckedObserver, ClassObserver, computedContext, ComputedPropertyObserver, elements, presentationElements, presentationAttributes, ObserverLocator, ObjectObservationAdapter, BindingExpression, sourceContext, targetContext, Binding, CallExpression, Call, ValueConverterResource, ListenerExpression, Listener, NameExpression, NameBinder;
  ...
  return {
    ...
    execute: function () {
      ...
      objectChangedContext = 'objectChanged';
      keyChangedContext = 'keyChanged';
      memberChangedContext = 'memberChanged';
      ...
      conditionAlways = function conditionAlways(primary) {
        return true;
      };

      childChangedContext = 'childChanged';
      ...
      BindingExpression = (function () {
        ...
        BindingExpression.create = function create(targetProperty, sourceExpression) {
          ...
          var parser = Container.instance.get(Parser),
